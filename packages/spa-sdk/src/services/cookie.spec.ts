...
describe('Cookie', () => {
  ...
  it('should return empty object if Window Document is not available', () => {
    jest.spyOn(Cookie, 'isWindowDocumentAvailable' as never).mockImplementation(() => false as never);
