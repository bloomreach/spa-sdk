...
export const VUE_APP_EXPONEA_PROJECT_TOKEN = process.env.VUE_APP_EXPONEA_PROJECT_TOKEN ?? '';
export const VUE_APP_EXPONEA_API_URL = process.env.VUE_APP_EXPONEA_API_URL ?? '';
