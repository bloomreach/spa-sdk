...
import { VUE_APP_EXPONEA_API_URL, VUE_APP_EXPONEA_PROJECT_TOKEN } from '@/utils/constants';
...
const exponeaProjectToken = VUE_APP_EXPONEA_PROJECT_TOKEN;
const exponeaApiUrl = VUE_APP_EXPONEA_API_URL;
