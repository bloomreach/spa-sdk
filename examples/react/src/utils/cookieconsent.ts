...
import { REACT_APP_EXPONEA_API_URL, REACT_APP_EXPONEA_PROJECT_TOKEN } from './constants';
...
const exponeaProjectToken = REACT_APP_EXPONEA_PROJECT_TOKEN;
const exponeaApiUrl = REACT_APP_EXPONEA_API_URL;
